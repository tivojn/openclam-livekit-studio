...
function companionStep(bounds, area, dx, dy, elapsedMs, remainder={x:0,y:0}, running=false) {
  ...
  const limit=(running===true?340:200)*Math.min(100,Math.max(0,elapsedMs))/1000;
