...
Image-generation references must have explicit roles. The original portrait is the face and hairstyle authority; a full-body reference may supply proportions and wardrobe only. Prompts must name the subject's actual hairstyle geometry, rather than merely asking for “the same hair,” so the walk and idle sources preserve the approved identity.
