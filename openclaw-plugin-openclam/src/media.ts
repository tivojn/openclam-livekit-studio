...
function safeFileName(candidate: string | undefined, source: string, mediaType: string): string {
...
export function uniqueMediaSources(mediaUrl?: string, mediaUrls?: string[]): string[] {
