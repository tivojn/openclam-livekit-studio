...
export const registerOpenClamCli = ({ program, config }) => {
    ...
    root
        ...
        .option("--bootstrap-secret-env <name>", "Environment variable holding the bridge bootstrap token", "OPENCLAM_BRIDGE_BOOTSTRAP_TOKEN")
        ...
        const options = {
            ...
            bootstrapSecretEnv: typeof raw.bootstrapSecretEnv === "string" ? raw.bootstrapSecretEnv : undefined,
